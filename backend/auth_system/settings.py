...
INSTALLED_APPS = [
        'corsheaders',  # <-- Add this as the first app!
...
DATABASES = {
    "default": {
        ...
        "OPTIONS": {
            ...
            "ssl": {
                "ca": os.environ.get("DB_OPTIONS_SSL_CA"),
            }
        }
    }
}
...
DJOSER = {
    ...
    'SERIALIZERS': {
        ...
        'user': 'accounts.serializers.UserDetailSerializer',        # <-- Affichage public
        'current_user': 'accounts.serializers.UserDetailSerializer', # <-- Profil connecté
...
# For some setups, you may also want:
